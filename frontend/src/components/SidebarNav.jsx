...
export const NAVIGATION_GROUPS = [
  ...
  },
  {
    ...
    items: [
      { id: 'rotten_blood', label: 'Bakragore Combat Timer & Taints', icon: Skull, badge: 'BIPS', badgeColor: 'bg-red-500/20 text-red-300 border-red-500/40' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'gear', label: 'Calculadora de Set & Resistências', icon: Shield, badge: 'LINK', badgeColor: 'bg-emerald-500/20 text-emerald-300 border-emerald-500/40' },
