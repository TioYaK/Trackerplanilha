...
async function testInspectDeepDiv() {
  ...
  try {
    ...
    const deepInfo = await page.evaluate(() => {
      ...
      const div3 = widget.querySelector('div > div > div');
      if (!div3) return { error: 'No div3' };
      return {
        innerHTML: div3.innerHTML,
        hasShadow: !!div3.shadowRoot,
        shadowHTML: div3.shadowRoot ? div3.shadowRoot.innerHTML : null,
      };
    });

    console.log('Resultado do div3:', JSON.stringify(deepInfo, null, 2));
